...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.map_option_menu = customtkinter.CTkOptionMenu(self.frame_left, values=["Open Street Map", "Google Map", "Google Earth"], command=self.change_map)
        ...
        self.map_option_menu.set("Google Earth")
    ...
    def change_map(self, new_map: str):
        ...
        elif new_map == "Google Map":
            self.map_widget.set_tile_server("https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=22)
        elif new_map == "Google Earth":
